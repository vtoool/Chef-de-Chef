  ...
  return (
    <footer className="bg-brand-brown-dark text-brand-cream py-8">
      <div className="container mx-auto max-w-6xl px-6 text-center">
        ...
        <p className="text-brand-cream/80 text-sm mb-5">Creating unforgettable moments through dance.</p>
        <div className="flex justify-center space-x-5 mb-6">
            ...
            <a href="tel:+37312345678" aria-label="Phone" className="hover:text-brand-gold transition-colors text-sm">Phone</a>
        </div>
        <div className="text-xs text-brand-cream/60">
            &copy; {new Date().getFullYear()} Ansamblul Chef de Chef. All rights reserved.
        </div>
      </div>
    </footer>
  );
