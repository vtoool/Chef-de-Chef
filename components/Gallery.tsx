...
const Gallery: React.FC = () => {
  ...
  return (
    <section id="galerie" className="py-16 md:py-24 bg-brand-cream">
      <div className="container mx-auto max-w-7xl px-6 text-center">
        <h2 className="font-serif text-3xl md:text-4xl font-bold text-brand-brown-dark mb-4">Galerie Foto & Video</h2>
