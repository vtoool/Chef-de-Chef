        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg h-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                    ...
                    {/* Facebook */}
                    <a href="https://facebook.com/chefdechef.md" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 group">
                        <div className="flex-shrink-0 w-12 h-12 bg-brand-orange/10 rounded-full flex items-center justify-center transition-colors group-hover:bg-brand-orange/20">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-brand-orange" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div>
                            ...
                            <span className="text-brand-brown-light group-hover:text-brand-orange group-hover:underline transition-colors text-md">Chef de Chef</span>
                        </div>
                    </a>
                    {/* Instagram */}
                    <a href="https://instagram.com/chefdechef.md" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 group">
                        <div className="flex-shrink-0 w-12 h-12 bg-brand-orange/10 rounded-full flex items-center justify-center transition-colors group-hover:bg-brand-orange/20">
                             <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-brand-orange" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div>
                            ...
                            <span className="text-brand-brown-light group-hover:text-brand-orange group-hover:underline transition-colors text-md">@chefdechef.md</span>
                        </div>
                    </a>
                </div>
            </div>
