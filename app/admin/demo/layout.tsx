        ...
        <div className="min-h-screen flex bg-gray-50 text-gray-800">
            <aside className={`fixed inset-y-0 left-0 z-40 w-60 bg-white border-r border-gray-200 flex flex-col transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <div className="flex items-center space-x-2 p-4 border-b border-gray-200">
                    <img src="/images/logo.webp" alt="Chef de Chef Logo" className="h-10 w-10 rounded-full object-cover" />
                ...
                <nav className="flex-1 p-4 space-y-2">
                    <div className="px-4 py-2 text-xs font-bold text-orange-600 bg-orange-50 rounded-lg mb-2">
                        DEMO MODE
                    </div>
                    <NavLink href="/admin/demo/rezumat" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" /><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" /></svg>}>
                        Panou de Bord
                    </NavLink>
                    <NavLink href="/admin/demo" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" /></svg>}>
                        Rezervări
                    </NavLink>
                    <NavLink href="/admin/demo/clients" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z" /></svg>}>
                        Clienți
                    </NavLink>
                </nav>
            ...
            <div className="flex-1 flex flex-col w-full overflow-hidden">
                <header className="lg:hidden bg-white border-b border-gray-200 p-4 flex justify-between items-center sticky top-0 z-10">
                    ...
                    <h1 className="text-lg font-bold text-gray-800">Panou Admin Demo</h1>
